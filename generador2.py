...
f = open('provagenerador2_' + str(nombrellibres) + '_' + str(nombredesitjats) + '_' + str(nombrellegits) + '_' + str(nombreparalels) + '_' + str(densitatpredecessors) + '.pddl', 'w')
...
f.write('(define (problem ext2_problema)\n  (:domain ext2_domini)\n  (:objects')
f.write('\n')
